...
### **Mockfirewall**
**Mockfirewall** provides you with connectivity and management capabilities such as device structure discovery and power management for the resource. 

For more information on the device, see the vendor's official product documentation.

### Standard version
**Mockfirewall** is based on the Firewall Shell Standard version **3.0.2**.
...
|:---|:---|
|Mockfirewall.zip|Device shell package|
|Mockfirewall_offline_dependencies.zip|Shell Python dependencies (for offline deployments only)|

# Importing and Configuring the Shell
This section describes how to import the **Mockfirewall** shell and configure and modify the shell’s devices.
...
1. Download the *Mockfirewall_offline_dependencies.zip* file, see [Downloading the Shell](#downloading-the-shell).
...
**To create a resource for the device:**
  ...
  2. From the list, select **Mockfirewall**.
...
For release updates, see the shell's [GitHub releases page](https://github.com/QualiSystems/Mockfirewall/releases).
